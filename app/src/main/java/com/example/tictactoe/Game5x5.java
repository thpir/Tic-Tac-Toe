...
public class Game5x5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myGridLayout = (GridLayout)findViewById(R.id.playField5x5);
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                String buttonID = "button5x5_" + i + j;
    ...
    private void singlePlayerMode() {
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 0 and see if the button to the right is still empty
            if (field[i][0].equals("O")
                    && field[i][1].equals("")) {
                buttons[i][1].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 1 and see if the button to the left is still empty
            if (field[i][1].equals("O")
                    && field[i][0].equals("")) {
                buttons[i][0].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 1 and see if the button to the right is still empty
            if (field[i][1].equals("O")
                    && field[i][2].equals("")) {
                buttons[i][2].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 2 and see if the button to the left is still empty
            if (field[i][2].equals("O")
                    && field[i][1].equals("")) {
                buttons[i][1].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 2 and see if the button to the right is still empty
            if (field[i][2].equals("O")
                    && field[i][3].equals("")) {
                buttons[i][3].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 3 and see if the button to the left is still empty
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 3 and see if the button to the right is still empty
            if (field[i][3].equals("O")
                    && field[i][4].equals("")) {
                buttons[i][4].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in column 4 and see if the button to the left is still empty
            if (field[i][4].equals("O")
                    && field[i][3].equals("")) {
                buttons[i][3].setText("O");
                return;
            }
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 0 and see if the button below is still empty
            if (field[0][i].equals("O")
                    && field[1][i].equals("")) {
                buttons[1][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 1 and see if the button above is still empty
            if (field[1][i].equals("O")
                    && field[0][i].equals("")) {
                buttons[0][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 1 and see if the button below is still empty
            if (field[1][i].equals("O")
                    && field[2][i].equals("")) {
                buttons[2][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 2 and see if the button above is still empty
            if (field[2][i].equals("O")
                    && field[1][i].equals("")) {
                buttons[1][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 2 and see if the button below is still empty
            if (field[2][i].equals("O")
                    && field[3][i].equals("")) {
                buttons[3][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 3 and see if the button above is still empty
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 3 and see if the button below is still empty
            if (field[3][i].equals("O")
                    && field[4][i].equals("")) {
                buttons[4][i].setText("O");
                return;
        ...
        for (int i = 0; i < 5; i++) { // check buttons in row 4 and see if the button above is still empty
            if (field[4][i].equals("O")
                    && field[3][i].equals("")) {
                buttons[3][i].setText("O");
                return;
            }
        ...
        if (field[0][3].equals("O") // check button 03 and check if button 14 is still empty
                && field[1][4].equals("")){
            buttons[1][4].setText("O");
            return;
        }
        ...
        if (field[0][4].equals("O") // check button 04 and check if button 13 is still empty
                && field[1][3].equals("")){
            buttons[1][3].setText("O");
            return;
        }
        ...
        if (field[1][3].equals("O") // check button 13 and check if button 04 is still empty
                && field[0][4].equals("")){
            buttons[0][4].setText("O");
            return;
        }

        if (field[1][3].equals("O") // check button 13 and check if button 24 is still empty
                && field[2][4].equals("")){
            buttons[2][4].setText("O");
            return;
        }

        if (field[1][4].equals("O") // check button 14 and check if button 03 is still empty
                && field[0][3].equals("")){
            buttons[0][3].setText("O");
            return;
        }

        if (field[1][4].equals("O") // check button 14 and check if button 23 is still empty
                && field[2][3].equals("")){
            buttons[2][3].setText("O");
            return;
        }
        ...
        if (field[2][3].equals("O") // check button 23 and check if button 14 is still empty
                && field[1][4].equals("")){
            buttons[1][4].setText("O");
            return;
        }

        if (field[2][3].equals("O") // check button 23 and check if button 34 is still empty
                && field[3][4].equals("")){
            buttons[3][4].setText("O");
            return;
        }

        if (field[2][4].equals("O") // check button 24 and check if button 13 is still empty
                && field[1][3].equals("")){
            buttons[1][3].setText("O");
            return;
        }

        if (field[2][4].equals("O") // check button 24 and check if button 33 is still empty
                && field[3][3].equals("")){
            buttons[3][3].setText("O");
            return;
        }
        ...
        if (field[3][0].equals("O") // check button 30 and check if button 41 is still empty
                && field[4][1].equals("")){
            buttons[4][1].setText("O");
            return;
        }
        ...
        if (field[3][1].equals("O") // check button 31 and check if button 40 is still empty
                && field[4][0].equals("")){
            buttons[4][0].setText("O");
            return;
        }

        if (field[3][1].equals("O") // check button 31 and check if button 42 is still empty
                && field[4][2].equals("")){
            buttons[4][2].setText("O");
            return;
        }
        ...
        if (field[3][2].equals("O") // check button 32 and check if button 41 is still empty
                && field[4][1].equals("")){
            buttons[4][1].setText("O");
            return;
        }

        if (field[3][2].equals("O") // check button 32 and check if button 43 is still empty
                && field[4][3].equals("")){
            buttons[4][3].setText("O");
            return;
        }
        ...
        if (field[3][3].equals("O") // check button 33 and check if button 24 is still empty
                && field[2][4].equals("")){
            buttons[2][4].setText("O");
            return;
        }

        if (field[3][3].equals("O") // check button 33 and check if button 42 is still empty
                && field[4][2].equals("")){
            buttons[4][2].setText("O");
            return;
        }

        if (field[3][3].equals("O") // check button 33 and check if button 44 is still empty
                && field[4][4].equals("")){
            buttons[4][4].setText("O");
            return;
        }

        if (field[3][4].equals("O") // check button 34 and check if button 23 is still empty
                && field[2][3].equals("")){
            buttons[2][3].setText("O");
            return;
        }

        if (field[3][4].equals("O") // check button 34 and check if button 43 is still empty
                && field[4][3].equals("")){
            buttons[4][3].setText("O");
            return;
        }

        if (field[4][0].equals("O") // check button 40 and check if button 31 is still empty
                && field[3][1].equals("")){
            buttons[3][1].setText("O");
            return;
        }

        if (field[4][1].equals("O") // check button 41 and check if button 30 is still empty
                && field[3][0].equals("")){
            buttons[3][0].setText("O");
            return;
        }

        if (field[4][1].equals("O") // check button 41 and check if button 32 is still empty
                && field[3][2].equals("")){
            buttons[3][2].setText("O");
            return;
        }

        if (field[4][2].equals("O") // check button 42 and check if button 31 is still empty
                && field[3][1].equals("")){
            buttons[3][1].setText("O");
            return;
        }

        if (field[4][2].equals("O") // check button 42 and check if button 33 is still empty
                && field[3][3].equals("")){
            buttons[3][3].setText("O");
            return;
        }

        if (field[4][3].equals("O") // check button 43 and check if button 32 is still empty
                && field[3][2].equals("")){
            buttons[3][2].setText("O");
            return;
        }

        if (field[4][3].equals("O") // check button 43 and check if button 34 is still empty
                && field[3][4].equals("")){
            buttons[3][4].setText("O");
            return;
        }

        if (field[4][4].equals("O") // check button 44 and check if button 33 is still empty
                && field[3][3].equals("")){
            buttons[3][3].setText("O");
            return;
        }
    ...
    private boolean checkForWin() {
        ...
        //First we are going to check all the rows for a win

        for (int i = 0; i < 5; i++) { // check rows for win part 1: column 1 to 3
        ...
        for (int i = 0; i < 5; i++) { // check rows for win part 2: column 2 to 4
        ...
        for (int i = 0; i < 5; i++) { // check rows for win part 3: column 3 to 5
        ...
        //Secondly we are going to check all the columns for a win

        for (int i = 0; i < 5; i++) { // check columns for win part 1: row 1 to 3
        ...
        for (int i = 0; i < 5; i++) { // check columns for win part 2: row 2 to 4
        ...
        for (int i = 0; i < 5; i++) { // check columns for win part 3: row 3 to 5
        ...
        //Third, we go diagonal from left to right...

        if (field[0][2].equals(field[1][3]) // check diagonal 02 to 24 left to right for win
        ...
        if (field[1][2].equals(field[2][3]) // check diagonal 12 to 34 left to right for win
        ...
        if (field[2][2].equals(field[3][3]) // check diagonal 22 to 44 left to right for win
        ...
        if (field[2][1].equals(field[3][2]) // check diagonal 21 to 43 left to right for win
                && field[2][1].equals(field[4][3])
                && !field[2][1].equals("")) {
            return true;
        }

        if (field[2][0].equals(field[3][1]) // check diagonal 20 to 42 left to right for win
                && field[2][0].equals(field[4][2])
                && !field[2][0].equals("")) {
            return true;
        }

        //Last, we go diagonal from right to left...
        ...
        if (field[0][4].equals(field[1][3]) // check diagonal 04 to 22 right to left for win
                && field[0][4].equals(field[2][2])
                && !field[0][4].equals("")) {
            return true;
        }

        if (field[1][3].equals(field[2][2]) // check diagonal 13 to 31 right to left for win
                && field[1][3].equals(field[3][1])
                && !field[1][3].equals("")) {
            return true;
        }

        if (field[2][2].equals(field[3][1]) // check diagonal 22 to 40 right to left for win
                && field[2][2].equals(field[4][0])
                && !field[2][2].equals("")) {
            return true;
        }

        if (field[1][4].equals(field[2][3]) // check diagonal 14 to 32 right to left for win
                && field[1][4].equals(field[3][2])
                && !field[1][4].equals("")) {
            return true;
        }

        if (field[2][3].equals(field[3][2]) // check diagonal 23 to 41 right to left for win
                && field[2][3].equals(field[4][1])
                && !field[2][3].equals("")) {
            return true;
        }

        return field[2][4].equals(field[3][3]) // check diagonal 24 to 42 right to left for win
